...
namespace UniversityManagement.Controllers
{
    public class EnrollmentsController : Controller
    {
        ...
        {
            ViewData["AssignmentId"] = new SelectList(_context.CourseAssignments, "Id", "Room");
        ...
        public async Task<IActionResult> Create([Bind("Id,StudentId,AssignmentId")] Enrollment enrollment)
        {
            ...
            ViewData["AssignmentId"] = new SelectList(_context.CourseAssignments, "Id", "Room", enrollment.AssignmentId);
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,StudentId,AssignmentId")] Enrollment enrollment)
        {
            if (id != enrollment.Id)
            {
                return NotFound();
